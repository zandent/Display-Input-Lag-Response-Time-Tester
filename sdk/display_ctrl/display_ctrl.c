...
int DisplayStart(DisplayCtrl *dispPtr)
{
    ...
    */
	...
	// RegValue |= dispPtr->curFrame;
	// xil_printf("DEBUG: XAXIVDMA_PARKPTR_OFFSET = 0x%08x\r\n", XAXIVDMA_PARKPTR_OFFSET);
	// xil_printf("DEBUG: RegValue = 0x%08x\r\n", RegValue);
	// xil_printf("DEBUG: curFrame = 0x%08x\r\n", dispPtr->curFrame);
